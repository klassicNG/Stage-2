      ...
      <div className="max-w-[1440px] mx-auto px-6 py-4 flex justify-between items-center bg-white">
        ...
        {props.isLoggedIn ? (
          ...
          <div className="hidden md:flex gap-4">
            <a
              href="/#features"
              className="text-green-800 py-2.5 px-3 hover:bg-green-50 transition-all duration-200"
            >
              Features
            </a>
            <a
            ...
            <Link
              to="/auth/login"
              className="bg-white border-green-800 text-green-800 py-2.5 px-6 rounded-lg hover:bg-green-50 transition-all duration-200"
            >
              Login
            </Link>
          </div>
