      ...
      <main className="flex-grow bg-slate-900 text-white">
        ...
        <div className="max-w-[1440px] mx-auto px-6 py-12">
          ...
          <div className="text-center mt-12">
            <Link
              to="/tickets/manage" // The route defined in routes.ts
              className="inline-block bg-green-700 text-white py-3 px-6 rounded-lg font-semibold text-lg hover:bg-green-800 transition-colors" // Apply button styles here
            >
              <FaTasks className="inline-block mr-2 align-middle" />{" "}
              {/* align-middle helps vertically center the icon with text */}
              Manage Tickets
            </Link>
          </div>
        </div>
