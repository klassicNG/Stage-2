...
const LandingPage: React.FC = () => {
  return (
    <main className="bg-slate-50 text-slate-800 font-sans">
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 py-12 flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-4">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-1/2 lg:ml-28 gap-5 z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <button className="bg-green-800 hover:bg-green-900 text-white py-2.5 px-6 rounded-lg shadow-sm transition-all duration-200">
                Get Started
              </button>
              <button className="bg-white border border-green-800 text-green-800 py-2.5 px-6 rounded-lg hover:bg-green-50 transition-all duration-200">
                Login
              </button>
            </div>
          </div>
      ...
      <section className="max-w-[1440px] mx-auto px-6 py-16 mt-10">
